...
Examples below are illustrative. Discover the exposed connector and actual schemas, columns, permissions, deduplication and refresh behavior before forming queries; none is a universal guarantee.
