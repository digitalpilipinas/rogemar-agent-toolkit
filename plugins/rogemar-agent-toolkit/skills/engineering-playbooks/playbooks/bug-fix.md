...
Choose regression checks with [Test Behavior, Not Implementation](../references/principles/test-behavior-not-implementation.md). Preserve meaningful negative and static contracts.
