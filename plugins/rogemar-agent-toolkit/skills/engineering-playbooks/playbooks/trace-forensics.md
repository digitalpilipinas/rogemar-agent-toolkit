...
1. Identify the format and load it with the right tool. When authorized and useful, request bounded parsing of large artifacts through the orchestrator (the **guard-the-context-window** skill) and keep the reduced finding in the main thread.
