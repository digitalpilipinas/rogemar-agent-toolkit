...
If no choice exists, ask once: “Which Forge mode should this task use: Balanced
(recommended), Peak, Lean or Sprint?” Use the host's supported question channel.
...
`Coordinator · Astra / medium · Balanced · model verified · source: saved preference`
...
`Explorer · Terra / medium requested · Balanced`
