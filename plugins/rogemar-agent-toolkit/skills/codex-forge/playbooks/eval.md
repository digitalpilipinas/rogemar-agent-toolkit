...
4. **Request bounded independent candidates through the orchestrator** using available profiles below both parent ceilings per the **forge-arena** skill's Phase B. Each works in its own sanitized dir; same prompt to each.
