...
export interface GitHubMergeAllowed {
  ...
  readonly mergeStateStatus: "CLEAN" | "HAS_HOOKS";
...
export interface ReadyPr {
  ...
  readonly proof: {
    ...
    readonly evidence: ReviewEvidence;
    readonly capturedAt: string;
    readonly base: {readonly name: string; readonly sha: string | null};
...
export interface GitHubReader {
  reviewEvidence(context: PrContext, head: string): Promise<ReviewEvidence>;
