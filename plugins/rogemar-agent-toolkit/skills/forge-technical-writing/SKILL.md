---
name: forge-technical-writing
description: "Layered forge-technical-writing standard: Diátaxis structure, Google developer style sentences, STE instruction rules, Global English syntax. Use for $forge-technical-writing or when writing or reviewing docs, RFCs, readmes, PR descriptions, or commit messages."
license: MIT
---
# Technical writing
...
Don't invent jargon. Use the words a developer would say out loud: "move", "delete", "a budget that only decreases", not "evacuate", "ratchet", or "endgame". A named pattern is fine when the doc says what it means the first time. Propose vocabulary updates to the owner of `forge-unslop`; do not edit that global skill implicitly.
...
- Apply the **forge-unslop** skill to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
...
Follow the user and repository formatting conventions, including indentation. This skill does not authorize editing another skill or vocabulary file. Treat universal prose prescriptions as advisory where they conflict with the requested artifact.
