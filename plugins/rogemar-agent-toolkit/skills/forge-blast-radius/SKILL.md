...
1. Read the change. The diff, the symbols it adds, changes, and deletes, and what it now does differently, including the part the diff doesn't spell out. Use `forge-why` step 2 to pull the PR and commits.
...
Write it through `forge-unslop`, cite real code, and strip anything private before it goes anywhere public.
